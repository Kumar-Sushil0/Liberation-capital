...
export const ScrollRevealSectionSlideBlank = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
  ...
  // Reset to initial state when entering slide (currentSection === 15)
  ...
  useEffect(() => {
    ...
    if (currentSection === 15 && prevSection !== 15 && isScrollEnabled) {
        ...
        if (progress < 1) {
          ...
          if (step >= 4 && currentSection === 15) {
            setTimeout(() => {
              ...
              if (window.gotoNextSlide && currentSection === 15) {
          ...
          <div className={styles.greyLineContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p className={styles.greyLineText}>
                Three one-hour rites to prime your psyche.
              </p>
              <p className={styles.greyLineText}>
                Every ascent begins with a psyche ready to rise.</p>
               <p className={styles.greyLineText}>
                One weekend transforms you, but first, the holy trinity prepares the ground: Pre → End → Me.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                ...
                <p className={styles.heroParagraph} style={{
                  ...
                  In one hour of play, you summon your timeline into the light;<br />
                  past and future fold into a version of you that finally feels right.
                </p>
              </div>
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                ...
                <p className={styles.heroParagraph} style={{
                  ...
                  In one hour of play, you face the futures where things don&apos;t go right;<br />
                  and from the dark, you rise finally knowing what you&apos;re willing to fight.
                </p>
              </div>
              <div className={styles.imageContent}>
                <Image
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                ...
                <p className={styles.heroParagraph} style={{
                  ...
                  In one hour of play, you craft the self who survives both rise and fall;<br />
                  the version of you steady enough to carry it all.
                </p>
              </div>
              <div className={styles.imageContent}>
                <Image
