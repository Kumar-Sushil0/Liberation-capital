...
export const ScrollRevealSectionSlide7New = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
  ...
  // Reset to initial state when entering slide (currentSection === 7)
  ...
  useEffect(() => {
    ...
    const smoothScrollToStep = (step, skipAnimation = false) => {
      ...
      if (skipAnimation || step === 0) {
        ...
        if (step === 4) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 7, step: 4 } 
          }));
        }
        
        if (step === 5) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 7, step: 5 } 
          }));
        }
        
        if (step === 6) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 7, step: 6 } 
          }));
          if (onAllColumnsVisible) {
            onAllColumnsVisible();
          }
        ...
        <div className={styles.scrollRevealMasterContainer} style={{
          ...
          <div className={styles.greyLineContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p className={styles.greyLineText}>
                Built for the ones who burn for more.
              </p>
              <p className={styles.greyLineText}>
                They&apos;re the ones who refuse to stay the same,
              </p>
              <p className={styles.greyLineText}>
                 and one weekend opens the door to the identities they&apos;re dying to claim.
              </p>
            </div>
          </div>
          ...
          <div className={styles.scrollRevealMainContent}>
            ...
            >
              ...
              >
                <span style={{ display: 'block', whiteSpace: 'nowrap' }}>You&apos;re not a pawn in someone&apos;s frame,</span>
                <span style={{ display: 'block', whiteSpace: 'nowrap' }}>you are the architect of your game.</span>
              </p>
            ...
            >
              ...
              >
                <span style={{ display: 'block', whiteSpace: 'nowrap' }}>They forged the maze and called it fate,</span>
                <span style={{ display: 'block', whiteSpace: 'nowrap' }}>a loop designed to captivate.</span>
              </p>
