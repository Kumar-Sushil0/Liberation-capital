...
export const ScrollRevealSectionSlide7 = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
  ...
  // Reset to initial state when entering slide (currentSection === 13)
  ...
  useEffect(() => {
    ...
    if (currentSection === 13 && prevSection !== 13 && isScrollEnabled) {
      // Reset to initial state when entering slide 6
      setSkipTransitions(true);
      setVisibleColumns(0);
        ...
        if (progress < 1) {
          ...
          if (step >= 4 && currentSection === 13) {
            setTimeout(() => {
              ...
              if (window.gotoNextSlide && currentSection === 13) {
            ...
            >
              ...
              <div className={styles.textContent}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Feels in color, speaks through fire,<br />
            ...
            >
              ...
              <div className={styles.textContent}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Finds the pattern in the blur,<br />
            ...
            >
              ...
              <div className={styles.textContent}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Trades the safe for paths unknown,<br />
