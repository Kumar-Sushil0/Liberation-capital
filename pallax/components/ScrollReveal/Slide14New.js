...
export const ScrollRevealSectionSlide14New = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
  ...
  // Reset to initial state when entering slide (currentSection === 17)
  ...
  useEffect(() => {
    ...
    if (currentSection === 17 && prevSection !== 17 && isScrollEnabled) {
    ...
    const smoothScrollToStep = (step, skipAnimation = false) => {
      ...
      if (skipAnimation || step === 0) {
        ...
        if (step === 1) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 17, step: 1 } 
          }));
        }
        
        if (step === 2) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 17, step: 2 } 
          }));
        }
        
        if (step === 3) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 17, step: 3 } 
          }));
          if (onAllColumnsVisible) {
            onAllColumnsVisible();
          }
      ...
      const animateScroll = (currentTime) => {
        ...
        if (progress < 1) {
          ...
          if (step >= 4 && currentSection === 17) {
            setTimeout(() => {
              // Double check we're still on slide before advancing
              if (window.gotoNextSlide && currentSection === 17) {
          ...
          <div className={styles.greyLineContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p className={styles.greyLineText} >
                A single weekend. A total redesign.
              </p>
              <p className={styles.greyLineText} >
                Your life won&apos;t change in a year, but it will change in one weekend.</p>
             <p className={styles.greyLineText} >
                Check in Friday noon as you are, Check out Sunday noon as someone new.</p>
            <p className={styles.greyLineText}>
                Solo Digital Retreat — an online game, designed to be played in an offline setting.
              </p>
            </div>
          </div>
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Meet the self you&apos;ve been living with,<br />
                  without society&apos;s noise holding the strings.
                </p>
              </div>
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Strip away money-made illusions,<br />
                  See what your goals look like without fantasy.
                </p>
              </div>
              <div className={styles.imageContent}>
                <Image
            ...
            >
              ...
              <div className={styles.textContent} style={{ flexDirection: 'column' }}>
                <p className={styles.heroParagraph} style={{
                  ...
                  Stand face-to-face with your capacity,<br />
                  how ready you truly are to go all in.
                </p>
              </div>
              <div className={styles.imageContent}>
                <Image
