...
/**
 * Slide4MobileDelusion - Mobile full-screen slide for Philosophy feature
 * Replaces the cramped 3-column layout on mobile
 */
const Slide4MobileDelusion = () => {
  return (
    <div className={styles.heroLayoutMobile}>
      ...
      <div className={styles.heroImageMobile}>
        <Image
          ...
          width={250}
          height={250}
          alt="Philosophy - Life i Design Game"
...
export default Slide4MobileDelusion;
