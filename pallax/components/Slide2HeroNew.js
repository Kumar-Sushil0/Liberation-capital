...
/**
 * Slide2HeroNew - Replica of Slide2Hero component
 * Displays the main hero content with the Life i Design value proposition
 * @returns {JSX.Element} Hero slide component
 */
const Slide2HeroNew = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
    ...
    const smoothScrollToStep = (step, skipAnimation = false) => {
      ...
      const animateScroll = (currentTime) => {
        ...
        if (progress < 1) {
          ...
          if (step >= 3 && currentSection === 14) {
            setTimeout(() => {
              if (window.gotoNextSlide && currentSection === 14) {
      ...
      <div className={styles.scrollRevealMasterContainer}>
        ...
        <div className={styles.greyLineContainer} style={{ zIndex: 10 }}>
          <p className={styles.greyLineText} style={{ color: '#888888', opacity: 1 }}>
            This is the doorway only instinct recognizes.
          </p>
        </div>
            ...
            <div className={styles.heroContentMobile}>
              <div className={styles.heroTextMobile}>
                <p className={styles.heroParagraphMobile}>
                  Some hesitate, but the chosen few move,
                </p>

                <p className={styles.heroParagraphMobile}>
                  they feel the pull long before they prove.
                </p>

                <p className={styles.heroParagraphMobile}>
                  When instinct roars, the path appears,
                </p>

                <p className={styles.heroParagraphMobile}>
                  sharp enough to slice through years.
                </p>

                <p className={styles.heroParagraphMobile}>
                  Step forward once, and the story claims you,
                </p>

                <p className={styles.heroParagraphMobile} style={{ color: '#888888' }}>
                  the weekend is waiting to re-name you.
                </p>
              </div>
            </div>
          </div>
