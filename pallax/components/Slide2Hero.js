...
const gamePassImageUrl = 'https://lidbucketnew.s3.ap-south-1.amazonaws.com/landingpage/slideassets/2.svg';

/**
 * Slide2Hero - Second slide component for the parallax experience
 * Displays the main hero content with the Life i Design value proposition
 * @returns {JSX.Element} Hero slide component
 */
const Slide2Hero = ({ onAllColumnsVisible, currentSection, isScrollEnabled = true }) => {
      ...
      <div className={styles.scrollRevealMasterContainer}>
        <div className={styles.greyLineContainer} style={{ zIndex: 10 }}>
          <p className={styles.greyLineText} style={{ color: '#888888', opacity: 1 }}>
            Begin again, one weekend to redesign you.
          </p>
        </div>
            ...
            <div className={styles.heroContentMobile}>
              <div className={styles.heroTextMobile}>
                <p className={styles.heroParagraphMobile}>
                  Welcome to <strong>LIFEiDESIGN.GAMES</strong>, the call to begin again.
                </p>
                <p className={styles.heroParagraphMobile}>
                  Break the mirror, burn the script, and write the life you mean.
                </p>
                <p className={styles.heroParagraphMobile}>
                  Fiction fuels the move; intuition maps the way.
                </p>
                <p className={styles.heroParagraphMobile}>
                  One weekend, one ritual, step in and start to play.
                </p>
                <p className={styles.heroParagraphMobile}>
                  This is the path. This is the play.
                </p>
                <p className={styles.heroParagraphMobile} style={{ color: '#888888' }}>
                  <strong>LIFEiDESIGN</strong> offers Online Games, designed to be played in an offline setting.
                </p>
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ padding: '6px 12px' }}>
              ...
              <div style={{ marginTop: '1px', color: '#ffffff', fontWeight: '600', fontSize: '11px', letterSpacing: '0.3px' }}>
                Intentional — Audacious — Unapologetic
              </div>
            </div>
          </div>
        </div>
