...
interface FundCoherenceSlideProps {
          ...
          <div className={styles.greyLineContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p className={styles.greyLineText}>
                Traction is performable. Coherence is unfakeable.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className={styles.textContent}>
                  <p className={styles.heroParagraph} style={{
                    ...
                    A coherent human compounds value faster than any business plan.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
