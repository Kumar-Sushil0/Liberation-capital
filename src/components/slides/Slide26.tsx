...
export const Slide26 = ({ 
  ...
  useEffect(() => {
    ...
    const slide26Index = 17;

    if (currentSection !== slide26Index) return;
  ...
  useEffect(() => {
    ...
    if (currentSection === slide26Index && prevSection !== slide26Index && isScrollEnabled) {
      setSkipTransitions(true);
      setVisibleColumns(0);
          ...
          <div style={{
            ...
            <div style={{
              ...
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem' }}>
                Before you touch capital, you must touch yourself — your patterns, your excuses, your discipline, your design.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem', fontWeight: 'bold' }}>
                You must play LIFEiDESIGN.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                Not as content. As confrontation.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '0.5rem', fontWeight: 'bold' }}>
                You must build alignment.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                Not as motivation. As mathematics.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '0.5rem', fontWeight: 'bold' }}>
                You must reach coherence.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                Not as a mood. As a measurable lifestyle.
              </p>
            </div>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, color: '#00e87b', fontSize: 'clamp(0.9rem, 1.5vw, 1.1rem)', lineHeight: 1.3, fontStyle: 'italic' }}>
              ...
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                • founders acting • markets hallucinating
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                • startups pretending • hype cycles recycling
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem' }}>
                ...welcome home.
              </p>
