...
interface FundCapitalSlideProps {
...
export const FundCapitalSlide = ({
  ...
  useEffect(() => {
    ...
    if (currentSection === 23 && prevSection !== 23 && isScrollEnabled) {
      setSkipTransitions(true);
      setVisibleColumns(0);
            ...
            >
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    The moment your life upgrades, you become a case study, a cultural signal, and a myth others chase.
                  </p>
                </div>
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Players turn into mythology. Mythology attracts new Patrons. Patrons fund new Players. The loop grows. The culture expands. The ecosystem evolves.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
