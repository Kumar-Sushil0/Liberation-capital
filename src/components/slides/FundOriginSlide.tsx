...
interface FundOriginSlideProps {
          ...
          <div className={styles.greyLineContainer}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <p className={styles.greyLineText}>
                The world funds everything except the human. We correct the mistake.
              </p>
            </div>
          </div>
              ...
              >
                ...
                <div className={styles.textContent}>
                  <p className={styles.heroParagraph} style={{
                    ...
                    Fix the human → the outcomes fix themselves.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
              ...
              >
                ...
                <div className={styles.textContent}>
                  <p className={styles.heroParagraph} style={{
                    ...
                    Investing in humans produces exponential returns.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
