...
interface FundCrucibleSlideProps {
      ...
      const animateScroll = (currentTime: number) => {
        ...
        if (progress < 1) {
          ...
          if (step >= 4 && currentSection === 17) {
            setTimeout(() => {
              if (typeof window !== 'undefined' && (window as any).gotoNextSlide && currentSection === 17) {
            ...
            >
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Revelation replaces performance. Your coherence speaks louder than your confidence.
                  </p>
                </div>
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Patrons don't interrogate. They observe who you've become through behavior, not persuasion.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
