...
export const Slide23 = ({ 
  ...
  useEffect(() => {
    ...
    const slide23Index = 16;

    if (currentSection !== slide23Index) return;
  ...
  useEffect(() => {
    ...
    if (currentSection === slide23Index && prevSection !== slide23Index && isScrollEnabled) {
      setSkipTransitions(true);
      setVisibleColumns(0);
      ...
      <div style={{ height: '200vh', position: 'relative' }}>
        <div style={{
          ...
          <div style={{
            ...
            {/* Column 1 - Case Studies Become Culture */}
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
              ...
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem' }}>
                A living identity economy powered by:
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.7rem, 1.3vw, 0.9rem)', lineHeight: 1.4, marginTop: '0.5rem', fontWeight: 'bold' }}>
                design → discipline → coherence → capital → culture → awakening → creation
              </p>
            </div>

            {/* Column 2 - Category-Defining Positioning */}
            <div style={{
              display: 'flex',
              flexDirection: 'column',
              alignItems: 'center',
              ...
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, fontWeight: 'bold' }}>
            ...
            <div style={{
              ...
              <p style={{ margin: 0, color: '#00e87b', fontSize: 'clamp(0.9rem, 1.5vw, 1.1rem)', lineHeight: 1.3, fontStyle: 'italic' }}>
                For Humans Re-designing Themselves
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem' }}>
                If you're redesigning your life, you shouldn't have to beg a broken system for permission.
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4, marginTop: '1rem', fontWeight: 'bold' }}>
                We fund:
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                • disciplined • self-aware
              </p>
              <p style={{ margin: 0, color: '#ffffff', fontSize: 'clamp(0.8rem, 1.5vw, 1rem)', lineHeight: 1.4 }}>
                • committed • evolving
              </p>
