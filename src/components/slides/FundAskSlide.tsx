          ...
          <div className={styles.greyLineContainer}>
            ...
            >
              <p className={styles.greyLineText}>
                The clean math your future self deserves.
              </p>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Patrons fund the required fuel, not performative requests.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Too little breaks the design. Too much breaks the character.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
