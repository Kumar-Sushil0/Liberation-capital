...
interface DistractionTestSlideProps {
            ...
            >
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Eligibility begins the moment your behavior matches the identity you claim to be building.
                  </p>
                </div>
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    The ecosystem measures coherence, not charisma; readiness, not hope; structure, not ambition.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
