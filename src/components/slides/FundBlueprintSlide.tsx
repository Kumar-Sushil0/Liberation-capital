    ...
    const smoothScrollToStep = (step: number, skipAnimation = false) => {
      ...
      if (skipAnimation || step === 0) {
        ...
        if (step === 1) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 18, step: 1 } 
          }));
        }
        
        if (step === 2) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 18, step: 2 } 
          }));
        }
        
        if (step === 3) {
          window.dispatchEvent(new CustomEvent('subscrollComplete', { 
            detail: { section: 18, step: 3 } 
          }));
          if (onAllColumnsVisible) {
            onAllColumnsVisible();
          }
      ...
      const animateScroll = (currentTime: number) => {
        ...
        if (progress < 1) {
          ...
          if (step >= 4 && currentSection === 18) {
            setTimeout(() => {
              if (typeof window !== 'undefined' && (window as any).gotoNextSlide && currentSection === 18) {
          ...
          <div className={styles.greyLineContainer}>
            ...
            >
              <p className={styles.greyLineText}>
                Your future self must be designed, not imagined.
              </p>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    Patrons invest in the architecture, not the aspiration.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
              ...
              >
                ...
                <div className={styles.textContent}>
                  ...
                  >
                    If the identity is stable, the life that follows becomes inevitable.
                  </p>
                </div>
                <div className={styles.imageContent}>
                  <img
