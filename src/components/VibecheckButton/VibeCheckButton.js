...
export const VibeCheckButton = ({ currentSection, inline = false, sections = [], onClick, isModalOpen = false }) => {
  ...
  return (
    <StyledWrapper style={wrapperStyle}>
      <div
        ...
        onBlur={handleBlur}
      >
        <div className="btn-drawer transition-top">Become a Player</div>
        <div className="btn-drawer transition-bottom">Become a Patron.</div>
        <button className="btn" onClick={handleClick}>
          <span className="btn-text">Fund Life</span>
        </button>
