    ...
    >
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-8">
        <div className="rounded-2xl bg-background shadow-lg ring-1 ring-black/5 p-8 text-center">
          <h4 className="text-3xl sm:text-4xl font-semibold">Where Capital Meets Conscious Evolution</h4>
          <div className="mt-3 text-foreground/80">
            <p>Most investors deploy money into products, markets, trends, and illusions of certainty.</p>
            <p className="mt-2">Liberation Capital deploys money into people who are redesigning the architecture of their lives —</p>
            <p>humans in metamorphosis, not humans in maintenance.</p>
            <p className="mt-2">You are not here to chase safer returns.</p>
            <p className="mt-2">You are here because something in you is ready to fund what the world will call “irrational”</p>
            <p>— until it becomes obvious.</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-8">
        <div className="rounded-2xl bg-background shadow-lg ring-1 ring-black/5 p-8 text-center">
          <h4 className="text-3xl sm:text-4xl font-semibold">Institutional Overview</h4>
          <div className="mt-6 text-foreground/80 leading-relaxed max-w-4xl mx-auto">
            <p>Liberation Capital is a philosophical investment institute.</p>
            <p className="mt-2">We operate on one premise:</p>
            <p className="mt-1 font-semibold">Human sovereignty compounds faster than software, markets, or machines.</p>
            <p className="mt-4">We do not invest in convenience.</p>
            <p>We invest in conscious evolution.</p>
            <p className="mt-4">Our capital backs individuals who:</p>
            <div className="mt-3 flex justify-center">
              <ul className="text-foreground/80 grid grid-cols-2 gap-x-6 gap-y-2 list-disc list-inside w-fit text-left">
                <li>confront their comfort</li>
                <li>rebuild their identity</li>
                <li>re-architect their life</li>
                <li>embrace disciplined becoming</li>
                <li>choose authorship over autopilot</li>
              </ul>
            </div>
            <p className="mt-4">This is not venture capital.</p>
            <p>This is a cultural investment order.</p>
          </div>
        </div>
      </div>
      ...
      <div className="mx-auto w-full max-w-6xl px-6 py-8">
        <div className="rounded-2xl bg-background shadow-lg ring-1 ring-black/5 p-8 text-center">
          <h4 className="text-3xl sm:text-4xl font-semibold">Funding Philosophy</h4>
          <div className="mt-6 text-foreground/80 leading-relaxed max-w-4xl mx-auto">
            <p>Most funds extract from human potential. We reverse that spell.</p>
           
            <p className="mt-4"> <span className="font-semibold">We do not say: </span>“Prove your worth so we may own your upside.”</p>
            
            <p className="mt-1"><span className="font-semibold">We say:</span> “Prove your devotion to your becoming — and we will become your temporary scaffolding.”</p>
            <div className="mt-6 flex justify-center">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left w-fit">
              <div>
                <p className="font-semibold mb-3">Our philosophy rejects:</p>
                <ul className="text-foreground/80 space-y-2 list-disc list-inside">
                  <li>saviour economics</li>
                  <li>exploitative clauses</li>
                  <li>ownership over identity</li>
                  <li>permanent dependency</li>
                  <li>spiritualized capitalism</li>
                </ul>
              </div>
              <div>
                <p className="font-semibold mb-3">We believe:</p>
                <ul className="text-foreground/80 space-y-2 list-disc list-inside">
                  <li>Alignment &gt; Ambition</li>
                  <li>Coherence &gt; Confidence</li>
                  <li>Discipline &gt; Dramatic Vision</li>
                  <li>Becoming &gt; Pitching</li>
                </ul>
              </div>
            </div>
            </div>
            <p className="mt-4">And above all: The human is the asset. Not the deck. Not the company. Not the performance.</p>
